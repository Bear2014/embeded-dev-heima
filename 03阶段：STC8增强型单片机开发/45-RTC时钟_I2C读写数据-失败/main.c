...
void I2C_Config()
{
	  ...
	  I2C_InitStructure.I2C_Mode = I2C_Mode_Master;  //主从设备选择 I2C_Mode_Master, I2C_Mode_Slave
	  I2C_InitStructure.I2C_Enable = ENABLE;         //I2C功能使用，ENABLE,DISABLE
	  I2C_InitStructure.I2C_MS_WDTA = DISABLE;       //主机使用自动发送，ENABLE,DISABLE(间隔一段时间自动发送)
	  I2C_InitStructure.I2C_Speed = 13;              //总线速度=Fosc/2/(Speed*2+4)   范围：0~63
